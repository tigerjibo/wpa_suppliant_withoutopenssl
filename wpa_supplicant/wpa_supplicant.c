                              ...
                              u8 *wpa_ie, size_t *wpa_ie_len)
{
        ...
        if (0) {
                ...
                wpa_msg(wpa_s, MSG_DEBUG, "WPA: using KEY_MGMT CCKM");
#endif
                              ...
                              struct wpa_scan_res *bss, struct wpa_ssid *ssid)
{
             ...
             WPA_KEY_MGMT_CCKM))) {
                ...
                if (wpa_supplicant_set_suites(wpa_s, bss, ssid,
                   ...
                   (WPA_KEY_MGMT_PSK | WPA_KEY_MGMT_IEEE8021X |
                    ...
                    WPA_KEY_MGMT_IEEE8021X_SHA256 | WPA_KEY_MGMT_CCKM)) {
                wpa_ie_len = sizeof(wpa_ie);
        ...
        {
          rekey_number = wpa_sm->rekey_number;
        }
                             ...
                             const u8 *buf, size_t len)
{
            ...
            eapol_sm_rx_eapol(wpa_s->eapol, src_addr, buf, len) > 0)
        {
            ...
            timeout = eapol_determine_timeout_period(wpa_s->eapol);
            if (timeout)
                    wpa_supplicant_req_auth_timeout(wpa_s, timeout, 0);
#endif
            return;
