                           ...
                           const char *msg, size_t msglen)
{
        ...
        case TYPE_BOTH:
                field = "BOTH";
                txt = "Identity & Password ";
                config->pending_req_identity_password++;
                break;
#endif
        case TYPE_PASSWORD:
                field = "PASSWORD";
...
#ifdef CONFIG_CCKM
void eap_sm_request_password_identity(struct eap_sm *sm)
{
        eap_sm_request(sm, TYPE_BOTH, NULL, 0);
}
#endif
...
#ifdef CONFIG_CCKM
        if (config->pending_req_identity_password)
                eap_sm_request_password_identity(sm);
#endif
}
